...
) ENGINE=InnoDB AUTO_INCREMENT=26895 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=49586 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=242029 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44595 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44603 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13448 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `debug_game_bat_rc5` AS select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = 'ソ') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ソ'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = 'ソ') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ソ'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = 'ロ') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ロ'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = 'ロ') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ロ'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '楽') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '楽'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '楽') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '楽'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '日') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '日'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '日') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '日'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '西') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '西'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '西') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '西'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = 'オ') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'オ'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = 'オ') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'オ'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '巨') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '巨'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '巨') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '巨'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '神') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '神'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '神') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '神'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = 'デ') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'デ'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = 'デ') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'デ'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '中') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '中'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '中') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '中'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = '広') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '広'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = '広') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = '広'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) union select `base`.`batter` AS `batter`,`base`.`all_bat` AS `all_bat`,`base`.`pa` AS `pa`,`base`.`b_team` AS `b_team`,`base`.`bat` AS `bat`,`base`.`hit` AS `hit`,`base`.`onbase` AS `onbase`,`base`.`total_base` AS `total_base`,`base`.`average` AS `average`,`base`.`average_onbase` AS `average_onbase`,`base`.`average_slugging` AS `average_slugging`,(`base`.`average_onbase` + `base`.`average_slugging`) AS `ops`,`other`.`hr` AS `hr`,`other`.`rbi` AS `rbi`,`other`.`bb` AS `bb`,`other`.`hbp` AS `hbp`,`base`.`eol` AS `eol` from (((select replace(`debug_base`.`current_batter_name`,' ','') AS `batter`,count(`debug_base`.`current_batter_name`) AS `all_bat`,sum(`debug_base`.`is_pa`) AS `pa`,`debug_base`.`b_team` AS `b_team`,sum(`debug_base`.`is_ab`) AS `bat`,sum(`debug_base`.`is_hit`) AS `hit`,sum(`debug_base`.`is_onbase`) AS `onbase`,sum(`debug_base`.`total_base`) AS `total_base`,round((sum(`debug_base`.`is_hit`) / sum(`debug_base`.`is_ab`)),3) AS `average`,round((sum(`debug_base`.`is_onbase`) / sum(`debug_base`.`is_pa`)),3) AS `average_onbase`,round((sum(`debug_base`.`total_base`) / sum(`debug_base`.`is_pa`)),3) AS `average_slugging`,'' AS `eol` from `baseball_2025`.`debug_base` where ((`debug_base`.`is_pa` = 1) and (`debug_base`.`b_team` = 'ヤ') and `debug_base`.`g_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ヤ'))) group by `debug_base`.`current_batter_name`,`debug_base`.`b_team` having (`pa` >= (3.1 * 5)))) `base` left join (select `baseball_2025`.`stats_batter`.`b_team` AS `b_team`,`baseball_2025`.`stats_batter`.`name` AS `name`,replace(`baseball_2025`.`stats_batter`.`name`,' ','') AS `batter`,sum(`baseball_2025`.`stats_batter`.`rbi`) AS `rbi`,sum(`baseball_2025`.`stats_batter`.`hr`) AS `hr`,sum(`baseball_2025`.`stats_batter`.`bb`) AS `bb`,sum(`baseball_2025`.`stats_batter`.`hbp`) AS `hbp` from `baseball_2025`.`stats_batter` where ((`baseball_2025`.`stats_batter`.`b_team` = 'ヤ') and `baseball_2025`.`stats_batter`.`game_info_id` in (select `game_id_recent_5days`.`id` from `baseball_2025`.`game_id_recent_5days` where (convert(`game_id_recent_5days`.`team` using utf8mb4) = 'ヤ'))) group by `baseball_2025`.`stats_batter`.`name`,`baseball_2025`.`stats_batter`.`b_team`) `other` on(((`base`.`batter` = `other`.`batter`) and (`base`.`b_team` = `other`.`b_team`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 SET collation_connection      = utf8mb4_general_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`baseball`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `game_cnt_per_month` AS select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 6 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`away_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 6) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 6 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`home_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 6) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) union select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 7 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,(case when isnull(count(`baseball_2025`.`game_info`.`away_team_initial`)) then 0 else count(`baseball_2025`.`game_info`.`away_team_initial`) end) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 7) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 7 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,(case when isnull(count(`baseball_2025`.`game_info`.`home_team_initial`)) then 0 else count(`baseball_2025`.`game_info`.`home_team_initial`) end) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 7) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) union select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 8 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`away_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 8) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 8 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`home_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 8) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) union select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 9 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`away_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 9) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 9 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`home_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 9) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) union select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 10 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`away_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 10) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 10 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`home_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 10) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) union select `tm`.`team_initial_kana` AS `team_initial_kana`,`tm`.`team_initial` AS `team_initial`,(case when (`away`.`month` is not null) then `away`.`month` when (`home`.`month` is not null) then `home`.`month` end) AS `month`,ifnull(`away`.`game_cnt`,0) AS `away_game_cnt`,ifnull(`home`.`game_cnt`,0) AS `home_game_cnt`,(ifnull(`away`.`game_cnt`,0) + ifnull(`home`.`game_cnt`,0)) AS `game_cnt`,'' AS `eol` from ((`baseball_2025`.`team_master` `tm` left join (select 11 AS `month`,`baseball_2025`.`game_info`.`away_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`away_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 11) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`away_team_initial`) `away` on((`away`.`team_initial` = `tm`.`team_initial_kana`))) left join (select 11 AS `month`,`baseball_2025`.`game_info`.`home_team_initial` AS `team_initial`,count(`baseball_2025`.`game_info`.`home_team_initial`) AS `game_cnt` from `baseball_2025`.`game_info` where ((date_format(str_to_date(`baseball_2025`.`game_info`.`date`,'%Y%m%d'),'%c') = 11) and (`baseball_2025`.`game_info`.`no_game` = 0)) group by `baseball_2025`.`game_info`.`home_team_initial`) `home` on((`home`.`team_initial` = `tm`.`team_initial_kana`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-09-01 19:57:55
