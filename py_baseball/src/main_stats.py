...
def main():
    ...
    try:
        ...
        pitch_stats_path = os.path.join(base_dir, "pitcherStats")
        bat_stats_path = os.path.join(base_dir, "batterStats")
        text_stats_path = os.path.join(base_dir, "text")
    ...
    print("\n--- Game stats collection finished successfully ---")
